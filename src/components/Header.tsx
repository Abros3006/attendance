...
export default function Header() {
  ...
  return (
    <>
      <header className="p-4 flex items-center bg-primary text-primary-foreground shadow-lg">
        <button
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-80 bg-card text-foreground shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          ...
          <div className="flex flex-row justify-between">
            <Link
              ...
              activeProps={{
                className:
                  'flex-1 flex items-center gap-3 p-3 rounded-lg bg-accent text-accent-foreground transition-colors mb-2',
              }}
            >
              <StickyNote size={20} />
